...
class __TwigTemplate_fb011bfb1370d26d41c105379c7b45db2b145709a3a8525224459b8fa71e3e37 extends Twig_Template
{
    private $source;
...
";
    ...
    <p id=\"<?php echo \$view->escape(\$id); ?>_help\" <?php echo ' '.\$view['form']->block(\$form, 'attributes', array('attr' => \$help_attr)); ?>><?php echo \$view->escape(false !== \$translation_domain ? \$view['translator']->trans(\$help, array(), \$translation_domain) : \$help); ?></p>
<?php endif; ?>
", "@Framework/Form/form_help.html.php", "/home/fabio/Pulpit/hackathon/tournament-scoreboard/vendor/symfony/framework-bundle/Resources/views/Form/form_help.html.php");
    }
}
